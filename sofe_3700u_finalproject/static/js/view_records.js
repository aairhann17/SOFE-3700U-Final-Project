...
function editRecord(id) {
    if(currentTable === 'artworks'){
        window.location.href = `/edit_artwork/${id}`;
        return;
    }
    dbApp.showAlert('Inline edit not available for this category.', 'info');
}
 ...
 */
function exportCSV() {
    window.open(`${API_BASE_URL}/export/artworks.csv`, '_blank');
    dbApp.showAlert('CSV export started', 'success');
}
 ...
 */
function exportPDF() {
    window.open(`${API_BASE_URL}/export/artworks.pdf`, '_blank');
    dbApp.showAlert('PDF export started', 'success');
}
